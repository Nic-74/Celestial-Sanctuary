...
import { mountContentTools } from './content-vault.js?v=20260917-savefix';
import { initPrivateMemories } from './private-memories.js?v=20260917-savefix';
// =****************************************************************==
...
import { initDanceMemory } from './dance-memory.js?v=20260917-savefix';
...
async function loadPanel(panelId) {
    ...
    try {
        const [cssModule, jsModule] = await Promise.all([
            ...
            import(`./modules/${panelId}.js?v=20260917-savefix`)
        ]);
...
function loadCssModule(panelId) {
    return new Promise((resolve, reject) => {
        ...
        link.id = cssId;
        link.rel = 'stylesheet';
        link.href = `css/modules/${panelId}.css?v=20260917-savefix`;
        link.onload = () => resolve();
